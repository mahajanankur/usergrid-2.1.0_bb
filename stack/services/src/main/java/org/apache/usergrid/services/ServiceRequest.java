...
public class ServiceRequest {
    ...
    public ServiceResults execute(boolean skipCheckPermission) throws Exception {
        try {
            return execute( null, skipCheckPermission );
        }
        catch ( Exception e ) {
    ...
    public ServiceResults execute( ServiceResults previousResults, boolean skipCheckPermission ) throws Exception {
        ...
        if ( s != null ) {
            results = s.invoke( action, this, previousResults, payload, skipCheckPermission );
    ...
    private ServiceResults invokeMultiple( ServiceResults previousResults ) throws Exception {
        ...
        if ( returnsTree ) {
            ...
            for ( ServiceRequest request : requests ) {
                ...
                ServiceResults rs = request.execute( previousResults, true );
                if ( rs != null ) {
