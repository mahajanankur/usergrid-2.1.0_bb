...
public class AbstractCollectionService extends AbstractService {
    ...
    @Override
    public ServiceResults getItemById1( ServiceContext context, UUID id, boolean skipPermissionCheck) throws Exception {

        return getItemById( context, id, skipPermissionCheck );
    }
    ...
    public ServiceResults getCollection( ServiceContext context ) throws Exception {
        ...
        if ( getCollectionSort( context ) != null ) {
            return getItemsByQuery( context, new Query(), false );
        }
    ...
    public ServiceResults getCollection1( ServiceContext context, boolean skipPermissionCheck  ) throws Exception {
        ...
        if ( getCollectionSort( context ) != null ) {
            return getItemsByQuery( context, new Query(), skipPermissionCheck );
        }
    ...
    @Override
    public ServiceResults putItemByName( ServiceContext context, String name, boolean skipCheckPermission ) throws Exception {
  ...
  // TODO -----This method is for internal use only to bypass permission check-----  
    @Override
