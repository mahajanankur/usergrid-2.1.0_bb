...
public abstract class AbstractContextResource {
    ...
    protected static boolean skipPermission;
	...
	/**
	 * @param skipPermission the skipPermission to set
	 */
	public static void setSkipPermission(boolean skipPermission) {
		AbstractContextResource.skipPermission = skipPermission;
	}
