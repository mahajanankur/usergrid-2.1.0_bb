...
public class ServiceResource extends AbstractContextResource {
   ...
   // @Autowired
    ...
    // TODO - BENTOBOX INTERNAL API TO BYBPASS PERMISSION CHECK
    
    @Path("__internal__"+"/"+"{itemName}")
    public AbstractContextResource addNameParameter2( @Context UriInfo ui, @PathParam("itemName") PathSegment itemName)
            throws Exception {
    ...
    public ServiceResults executeServiceRequest( UriInfo ui, ApiResponse response, ServiceAction action,
        ...
        ServiceResults results = r.execute(skipCheckPermission);
    ...
    public JSONWithPadding executeGet( @Context UriInfo ui,
        ...
        executeServiceRequest( ui, response, ServiceAction.GET, null,isSkipPermission());
    ...
    public JSONWithPadding executePostWithObject( @Context UriInfo ui, Object json,
        ...
        executeServiceRequest( ui, response, ServiceAction.POST, payload,false );
    ...
    public JSONWithPadding executePutWithMap( @Context UriInfo ui, Map<String, Object> json,
        ...
        executeServiceRequest( ui, response, ServiceAction.PUT, payload,false );
    ...
    public JSONWithPadding executePost( @Context UriInfo ui, String body,
        ...
        executeServiceRequest( ui, response, ServiceAction.POST, payload, isSkipPermission());
    ...
    public JSONWithPadding executeDelete(
        ...
        ServiceResults sr = executeServiceRequest( ui, response, ServiceAction.DELETE, null,false );
    ...
    private JSONWithPadding executeMultiPart( UriInfo ui, String callback, FormDataMultiPart multiPart,
        ...
        ServiceResults serviceResults = executeServiceRequest( ui, response, serviceAction, payload,false );
    ...
    public Response uploadDataStream( @Context UriInfo ui, InputStream uploadedInputStream ) throws Exception {
        ...
        response.setApplication( services.getApplication() );
        response.setParams( ui.getQueryParameters() );
        ServiceResults serviceResults = executeServiceRequest( ui, response, ServiceAction.GET, null,false );
