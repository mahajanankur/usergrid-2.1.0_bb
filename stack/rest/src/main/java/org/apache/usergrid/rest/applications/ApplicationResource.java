...
import org.apache.usergrid.rest.bentobox.BentoboxResources;
...
public class ApplicationResource extends ServiceResource {
	...
	// TODO - BENTOBOX CHANGES - START
	@Path("bentobox")
	public BentoboxResources bentoResource(@Context UriInfo ui) throws Exception {
		logger.debug("ApplicationResource.bentoResource");
		addParameter(getServiceParameters(), "bentobox");

		PathSegment ps = getFirstPathSegment("bentobox");
		if (ps != null) {
			addMatrixParams(getServiceParameters(), ui, ps);
		}

		return getSubResource(BentoboxResources.class);
	}
	// TODO - BENTOBOX CHANGES - END
